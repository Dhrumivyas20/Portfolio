document.addEventListener('DOMContentLoaded', () => {
    ...
    let typingSpeed = 130; // Speed of typing characters
    let deletingSpeed = 60; // Speed of deleting characters
    let pauseAfterType = 1500; // Pause after typing a role
    let pauseAfterDelete = 400; // Pause after deleting a role
